...
const ModalTransactionItemDetail = ({
  courirDuration,
  transactionItems,
  transactionId,
  moment,
  ...
  const receiptNo = `2208${moment(paymentDate).format(
    "YYMMDD"
  )}${transactionId}`;
  ...
  return (
    <Modal
      ...
      onOpen={onOpen}
      onClose={onClose}
      motionPreset={{ lg: "none", base: "slideInBottom" }}
    >
      <ModalOverlay />
      <ModalContent
        maxW="532.54px"
        mt={{ lg: "99px", base: "220px" }}
        borderRadius={"12px"}
      >
            ...
            >
              ...
              <Box display={"flex"} flexDir={"column"}>
                ...
                >
                  ...
                  <Text>{transactionAddress.full_address}</Text>
                  <Text>
                    {transactionAddress.districts}, {transactionAddress.city},{" "}
              ...
              >
                {
                  new Intl.NumberFormat("id-ID", {
                    ...
                    .format(totalPrice - 1000 - shippingFee)
                    .split(",")[0]
                }
              </Text>
            </Box>
