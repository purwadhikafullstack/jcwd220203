import { AlertDialog, AlertDialogBody, AlertDialogContent, AlertDialogFooter, AlertDialogHeader, AlertDialogOverlay, Box, Button, Checkbox, Grid, GridItem, Image, Text, useDisclosure, useToast } from "@chakra-ui/react"
    ...
    if (!cartSelector.cart.length) {
        ...
        return (
            <>
                {/* cart filled */}
                <Box mt={'67px'} >
                    <Box width={'1070px'} h={'66px'} m={'0px 231.5px'} p={'40px 20px 0px'} mx={"auto"} mt={'5px'}>
                        <Text fontSize={'20px'} color="#31353BF5" fontWeight={'700'} fontFamily={"Open Sauce One,Nunito Sans, sans-serif"}>
                            Cart
                        </Text>
                    </Box>
                    <Grid minH={'200px'} width="710" maxWidth={'1027px'} margin={'auto'} p={'0x 24px'} templateColumns='3.8fr 1.7fr' gap={2} mt={'10px'} >
                        <GridItem w='100%' >
                            <Box w={'710px'} boxShadow={"0 0 10px 0 rgb(0 0 0 / 10%) !important"} borderRadius={"15px"} pl={'28px'} border={"1px solid #99d5f0"}>
                                <Box h={'52px'} width={'650px'} p="16px 0" display={'flex'} justifyContent={'space-between'} mt={'8px'}>
                                    <Checkbox
                                        ...
                                        size={'lg'}
                                    >
                                        <Text fontSize={'14px'} color={'#31353BAD'} fontWeight={'400px'} fontFamily={"Open Sauce One,Nunito Sans, sans-serif"}  >
                                            Select All
                                        </Text>
                                    </Checkbox>
                        ...
                        {/* Shopping Summary */}
                        <GridItem pl={'30px'}>
                            <Box w={'318.02px'} h={'236.88px'} p={'16px'} boxShadow={"0 0 10px 0 rgb(0 0 0 / 10%)"} borderRadius={"15px"} border={"1px solid #99d5f0"}>
                                <Text
                                    fontWeight={'600'}
                                    position={'relative'}
                                    fontSize={'16px'}
                                ...
                                <Box display={'flex'} justifyContent={"space-between"} borderBottom={"1px solid #E5E7E9"} pb={'16px'}>
                                    <Text
                                        color={'#31353BAD'}
                                        fontFamily={"Open Sauce One, Nunito Sans, -apple-system, sans-serif"}
                                        fontSize={'14px'}
