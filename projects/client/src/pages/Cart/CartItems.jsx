    ...
    <>
      <Box display={{ lg: "inline", base: "none" }}>
        ...
        <Box
          ...
          display={"block"}
        >
          <Box height={"71.8px"} width={"630px"} pl={"3px"}>
            {/* if stock = 0 */}
            {productStocks === 0 ? (
              <Text
                fontSize={"14px"}
            ...
            <HStack>
              {/* Checkbox */}
              <Box width={"20px"} height={"20px"} bgColor={"#fff"} p={"0"}>
                <Checkbox
                  borderColor={"#6C727C"}
                  size={"lg"}
                  isChecked={isChecked}
              ...
              {/* Product Detail */}
              <Box cursor={"pointer"} pl={"12px"} onClick={productBtnHandler}>
                <Image
                  src={productImage}
                  minWidth={"69px"}
                  minHeight={"69px"}
      ...
      <Box display={{ lg: "none", base: "inline" }}>
        <Box
          h={
            addNote === true ? "227px" : productStocks === 0 ? "174px" : "164px"
          }
          maxWidth={"468px"}
          m={"0px 16px"}
          p={"16px 0px 16px"}
