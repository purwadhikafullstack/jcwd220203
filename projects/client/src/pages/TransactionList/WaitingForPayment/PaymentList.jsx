...
import { fillUnpaidTrans } from "../../../redux/features/transSlice";
          ...
          {count === 0 ? (
            ...
            >
              ...
              <Text
                ...
                lineHeight={"16px"}
              >
                Come on, start shopping and fulfill your various needs at
                Shopedia.
              </Text>
              <Link to={"/"}>
                <Button
            ...
            <Box>{isLoading && <Box>{renderPaymentListItem()}</Box>}</Box>
          )}
        </Box>
      </Box>
