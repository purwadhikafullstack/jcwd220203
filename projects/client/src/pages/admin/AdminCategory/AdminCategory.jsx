import { Box, Button, CircularProgress, FormControl, GridItem, HStack, Image, Input, InputGroup, InputRightElement, Select, Table, Tbody, Td, Text, Tfoot, Th, Thead, Tr, useDisclosure, useToast, VStack } from "@chakra-ui/react"
        ...
        <>
            <Box mt={'40px'} width="750px" h={'750px'} ml={'500px'}>
                ...
                <Box
                    ...
                    width={'610px'}
                >
                    <Table mt={'-5px'} variant={count === 0 || isLoading === false ? 'simple' : 'striped'}>
                        ...
                        {isLoading === false ? (
                            <Tbody bgColor={"white"} maxW={'450px'}>
                                <Tr>
                                    <Td bgColor={'#fff'}>
                                        <Box mt={'70px'} display={'flex'} ml={'250px'} justifyContent={'center'} alignItems={'center'} alignContent={'center'}>
                                            <CircularProgress isIndeterminate color='#F7931E' thickness='40px' size='60px' />
                                        </Box>
                                    </Td>
                                </Tr>
                            </Tbody>
