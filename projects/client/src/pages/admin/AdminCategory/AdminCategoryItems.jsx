...
const AdminCategoryItems = ({ CategoryId, fetchCategory, category_name, category_image, onDelete, isOpenAddNewCategory, onCloseAddNewCategory, inputFileRef }) => {
    ...
    const editFormik = useFormik({
        ...
        onSubmit: async ({ category_name, category_image }) => {
            try {
                ...
                const response = await axiosInstance.patch(`/admin/categories/${CategoryId}`, newCategory)
    ...
    return (
        <>
            ...
            <Tr >
                ...
                <Td>
                    <Image mx={'auto'} src={`${apiImg}/${category_image}`} width={'80px'} height={'80px'} />
                </Td>
