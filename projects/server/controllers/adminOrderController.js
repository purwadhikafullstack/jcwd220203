...
const adminOrderController = {
  ...
  approvePayment: async (req, res) => {
    try {
      ...
      const rawHTML = fs.readFileSync(
        path.resolve(__dirname, ".././templates/approvePayment.html"),
        "utf-8"
      );
      ...
      const htmlResult = compiledHTML({
        ...
        shopediaLink: process.env.DOMAIN_NAME,
      });
  ...
  rejectPayment: async (req, res) => {
    try {
      ...
      const uploadLink = `${process.env.DOMAIN_NAME}/payment/thank-you/shopedia/${findTransaction.transaction_name}`;

      const rawHTML = fs.readFileSync(
        path.resolve(__dirname, ".././templates/rejectTransaction.html"),
        "utf-8"
      );
